...
export default function AboutPage() {
  ...
  const features = [
    { icon: <HeartHandshake size={22}/>, title: t('about.values.craft'), desc: t('about.values.craftDesc') },
    { icon: <Sparkles size={22}/>, title: t('about.values.creativity'), desc: t('about.values.creativityDesc') },
    { icon: <Layers size={22}/>, title: t('about.values.quality'), desc: t('about.values.qualityDesc') },
  ];
  ...
  return (
    <div className="min-h-screen bg-sand text-ink">
      <div className="bg-gradient-to-br from-sunset to-berry py-16 px-4 text-center text-white">
        ...
        <p className="text-lg opacity-90 max-w-2xl mx-auto">{t('about.subtitle')}</p>
      </div>
